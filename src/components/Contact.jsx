  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-10 flex flex-col items-center">
        ...
        <div
          ref={formRef}
          className="w-full rounded-3xl overflow-hidden grid md:grid-cols-2 gap-0 bg-white border border-gray-200 min-h-[500px]"
        ...
        >
          ...
          {/* Right — contact info */}
          <div className="p-12 md:p-20 bg-gray-50 text-black flex flex-col justify-center">
            <h2
              className="font-display font-black text-black mb-16"
            ...
            <div className="space-y-8">
              ...
              <a
                ...
                className="flex items-center gap-4 p-6 rounded-2xl bg-gray-200/50 border border-gray-300 hover:bg-gray-200 hover:border-golden/50 transition-all duration-300"
              >
                <div className="text-2xl">✉️</div>
                <div>
                  <p className="text-xs font-display tracking-widest uppercase text-gray-600 mb-1">
                    Email
                  </p>

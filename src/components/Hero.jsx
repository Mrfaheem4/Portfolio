    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        { y: 150, opacity: 0 },
        {
          ...
          ease: "power4.out",
          onComplete: () => {
            // PARALLAX: use scrollEnd that matches the pin duration in App.jsx
            // App pins hero for +=180vh, so we match that end point
            gsap.to(leftDivRef.current, {
              y: -200, // reduced — they don't need to go far since hero exits anyway
              scrollTrigger: {
                trigger: sectionRef.current,
                start: "top top",
                end: "+=180%", // matches App.jsx pin end
                scrub: true,
              },
            });
